		...
		<div className="space-y-8">
			<div className="flex flex-col gap-2">
				...
				<p className="text-slate-400 max-w-2xl">
					Unified navigation for the local MCP ecosystem. Launch strategic
					services and monitor cross-service orchestration from this central
					hub.
				</p>
			</div>
			...
			<div className="p-8 rounded-3xl border border-dashed border-emerald-500/10 bg-emerald-500/[0.02] flex flex-col items-center justify-center text-center gap-4">
				...
				<div>
					...
					<p className="text-sm text-slate-500">
						Fleet status is continuously monitored via the secondary discovery
						protocol.
					</p>
				</div>
			</div>
