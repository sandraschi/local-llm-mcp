...
DEFAULT_MANIFEST = {
    ...
    "long_description": (
        "A Model Control Protocol (MCP) server that provides a unified interface to multiple LLM providers "
        "including Ollama, Anthropic, and others. Supports model listing, text generation, and conversation management."
    ),
    "author": {
        "name": "Your Name",
            ...
            if mcp_instance and hasattr(mcp_instance, "_tool_manager"):
                ...
                try:
                    ...
                    for tool_name, tool in mcp_tools.items():
                        ...
                        async def tool_wrapper(tool=tool, **kwargs):
