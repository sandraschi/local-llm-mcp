import { Cpu, Globe, HelpCircle, Info, ShieldCheck, Terminal, Zap } from "lucide-react";
    ...
    <div className="p-8 max-w-7xl mx-auto animate-in fade-in duration-700">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-4xl font-bold text-white tracking-tight">
            Fleet Help & Documentation
          </h1>
          <p className="text-gray-400 mt-1">
            Master your local inference infrastructure and agentic workflows.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-1 lg:col-span-2 p-6 rounded-3xl bg-gradient-to-br from-indigo-500/10 via-transparent to-purple-500/10 border border-white/10 backdrop-blur-xl relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="px-3 py-1 bg-purple-500/20 text-purple-300 text-xs font-bold rounded-full border border-purple-500/30 uppercase tracking-widest">
                SOTA 2026
              </span>
            </div>
            <h2 className="text-3xl font-bold text-white mb-2">Qwen 3.6-35B-A3B Integration</h2>
            <p className="text-gray-300 leading-relaxed mb-6 max-w-2xl">
              The current standard for local **Agentic Coding**. This sparse Mixture-of-Experts
              (MoE) model activates only 3 billion parameters per token, providing unmatched speed
              for complex multi-file reasoning tasks.
            </p>
        ...
        <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-400 mt-2 text-sm leading-relaxed">
              Your agentic fleet operates on a **Zero-Telemetry** principle. All inference data
              remains within your local network, processed by Ollama, LM Studio, or vLLM.
            </p>
          </div>
        ...
        <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl group hover:border-blue-500/30 transition-all">
          ...
          <p className="text-blue-400 text-xs font-bold mt-1 uppercase tracking-tighter">
            Preferred (SOTA)
          </p>
          <p className="text-gray-400 mt-3 text-sm leading-relaxed">
            The fleet server heartbeats every 5 seconds to scan local ports (**11434**, **1234**,
            **8000**). If a model is running, it joins the federation automatically.
          </p>
        ...
        <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl border-dashed opacity-70">
          ...
          <p className="text-gray-500 text-xs font-bold mt-1 uppercase tracking-tighter">
            Legacy Pattern
          </p>
          <p className="text-gray-500 mt-3 text-sm leading-relaxed lowercase italic">
            Manual port mapping and static model manifests. Use only if discovery fails or if
            tunneling through an external VPN.
          </p>
          <div className="mt-4 flex gap-2">
            <span className="px-2 py-1 bg-gray-500/10 text-gray-500 text-[10px] rounded border border-gray-500/20">
              .env override
            </span>
            <span className="px-2 py-1 bg-gray-500/10 text-gray-500 text-[10px] rounded border border-gray-500/20">
              Model Hub
      ...
      <div className="mt-12 p-8 rounded-[40px] bg-gradient-to-r from-blue-600/20 to-indigo-600/20 border border-blue-500/30 flex flex-col md:flex-row items-center justify-between gap-8">
        <div>
          ...
          <p className="text-gray-300">
            Check the central fleet documentation for advanced architectural patterns.
          </p>
        </div>
        <a
