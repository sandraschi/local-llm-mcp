...
from llm_mcp.tools.generation_tools import generate_text_impl, chat_completion_impl, embed_text_impl
...
async def llm_generation(
    ...
    Instead of creating 3 separate generation tools (one per operation), this tool consolidates
