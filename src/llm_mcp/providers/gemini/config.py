...
class GeminiConfig(BaseModel):
    ...
    api_key: str | None = Field(None, description="Google AI API key")
    ...
    model_config = ConfigDict(env_prefix="GEMINI_")  # pyright: ignore[reportCallIssue]  # pydantic 2.12 ConfigDict typing
