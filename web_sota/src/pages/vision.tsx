import { type ModelInfo, listModels } from "@/api/client";
			...
			<div className="flex flex-wrap items-center justify-between gap-4">
				<div className="flex flex-col gap-2">
					...
					<p className="text-slate-400 max-w-2xl">
						Multimodal intelligence playground. Test image-to-text capabilities
						with Gemma 4 and local vision-SOTA models.
					</p>
				</div>
				<ModelSelector
					models={models}
