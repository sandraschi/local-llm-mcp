...
class PerplexityConfig(BaseModel):
    ...
    api_key: str | None = Field(None, description="Perplexity API key")
    ...
    model_config = ConfigDict(env_prefix="PERPLEXITY_")  # pyright: ignore[reportCallIssue]  # pydantic 2.12 ConfigDict typing
