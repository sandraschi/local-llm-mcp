		...
		<div className="space-y-8">
			<div>
				...
				<p className="text-slate-400 mt-2">
					Real-time telemetry and performance orchestration metrics for the LLM
					infrastructure.
				</p>
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
				{stats.map((s) => (
					<Card
						key={s.label}
						className="border-white/5 bg-white/[0.02] backdrop-blur-md"
					>
					...
					<CardContent>
						<div className="space-y-4">
							{[
								{
									time: "2m ago",
									event: "Ollama Provider Heartbeat",
									status: "ok",
								},
								{
									time: "15m ago",
									event: "New Model Registered: llama3.1",
									status: "info",
								},
								{
									time: "1h ago",
									event: "API Config Patched via WebUI",
									status: "warn",
								},
								{
									time: "2h ago",
									event: "vLLM Instance Re-optimized",
									status: "ok",
								},
							].map((log, _i) => (
								<div
								...
								>
									...
									<span className="text-slate-300 flex-1 ml-4">
										{log.event}
									</span>
									<span
										className={cn(
