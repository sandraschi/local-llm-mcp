import { type TelemetryResponse, getTelemetry } from "@/api/telemetry";
		...
		return (
			<div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
				...
				<p className="text-slate-400 font-medium">
					Initializing Performance Foundry...
				</p>
			</div>
		);
	}
			...
			<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
				...
				<Card className="glass-card overflow-hidden group">
					...
					<CardContent>
						...
						<p className="text-[10px] text-slate-500 mt-2 uppercase tracking-widest">
							{(gpu.used_mb / 1024).toFixed(1)}GB /{" "}
							{(gpu.total_mb / 1024).toFixed(1)}GB
						</p>
					</CardContent>
				</Card>
			</div>
