...
class VLLMDockerManager:
    ...
    async def start_vllm_container(
        ...
        **kwargs,
        ...
        try:
            # Start the container
            self.container = self.docker_client.containers.run(command=command, **container_config)
    ...
    async def benchmark_performance(
        self, test_prompt: str = "Hello, how are you today?", max_tokens: int = 50
    ) -> dict[str, Any]:
    ...
    def _calculate_cpu_usage(self, stats: dict) -> float | None:
